...
## Управление состоянием приложений [Управление состоянием приложений](https://github.com/NayrGosling/NOTES_ON_GOLANG_IN_RUSSIAN/blob/main/Kubernetes/Безопасность%20в%20Kubernetes.md)
